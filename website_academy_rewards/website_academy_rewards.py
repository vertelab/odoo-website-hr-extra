...
class academy_rewardee(models.Model):  # who took prize
    ...
    def _name_(self):
        for rec in self:
            rec.name = '%s - %s' % (rec.reward_id.name, rec.reward_year)
...
#             cr, odoo.SUPERUSER_ID, domain, ["id", "country_id"],
#             groupby="country_id", orderby="country_id", context=request.context)
#         country_count = partner_obj.search(
#             cr, odoo.SUPERUSER_ID, domain, count=True, context=request.context)
#
#         if country_id:
...
#         partner_count = partner_obj.search_count(cr, odoo.SUPERUSER_ID, domain, context=request.context)
#
#         # pager
#         url = '/customers'
#         if country_id:
...
#         )
#
#         partner_ids = partner_obj.search(request.cr, odoo.SUPERUSER_ID, domain,
#                                          offset=pager['offset'], limit=self._references_per_page,
#                                          context=request.context)
#         google_map_partner_ids = ','.join(map(str, partner_ids))
#         partners = partner_obj.browse(request.cr, odoo.SUPERUSER_ID, partner_ids, request.context)
#
#         values = {
#             'countries': countries,
